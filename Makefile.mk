...
# xfailtests.mk, checkdata.mk, and deps.mk. If tests.mk and deps.mk
# are maintained differently, this code below can be removed.
#
# Generate deps.mk, tests.mk, checkdata.mk, and xfailtests.mk by executing
#   make -sf Makefile.mk
...
MKFILES = deps.mk tests.mk xfailtests.mk checkdata.mk
...
# Makefile.am.
 ${testsrc}/deps.mk: ${testsrc}/tests.list
	echo "# This file is generated by 'make -f Makefile.mk $@'" > $@
	${PERL} \
	  -e 'while(<>) {' \
	  -e '  /(\S+)\t(\S+)\t(\S+)/; $$e=$$1; $$f=$$2; $$t=$$3;' \
